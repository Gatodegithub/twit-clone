<template>
  <div class="flex flex-col min-h-screen">
    ...
    <footer class="grid grid-cols-4 border-t border-gray-600">
      <router-link v-for="(route, i) in routes" :key="i" :to="route.path" :class="`p-4 text-center text-2xl ${
...
export default {
  setup() {
    ...
    // Antes de montar el template traigo las rutas que tengan el atributo mainMenu
    onBeforeMount(() => {
